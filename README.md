...
**Interactive prompt:** For agents that support yolo but don't store it (Claude, Copilot CLI, Gemini, Kiro), you'll see a modal asking whether to resume in yolo mode. Use Tab to toggle, Enter to confirm.
